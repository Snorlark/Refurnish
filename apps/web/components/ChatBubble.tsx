  ...
  return (
    <div className={`fixed bottom-4 md:bottom-6 right-4 md:right-6 z-50 ${className}`}>
      <button 
        ...
        className="w-12 h-12 md:w-14 md:h-14 bg-green-900 rounded-full flex items-center justify-center text-white shadow-lg hover:bg-green-800 transition-all duration-300 hover:scale-110"
      >
        ...
        <div className="absolute bottom-14 md:bottom-16 right-0 w-72 md:w-80 h-80 md:h-96 bg-white rounded-lg shadow-xl border flex flex-col">
          ...
          <div className="p-3 md:p-4 border-t">
            <div className="flex space-x-2">
              ...
              />
              <button className="bg-green-900 text-white px-3 md:px-4 py-2 rounded-lg hover:bg-green-800 transition-colors">
