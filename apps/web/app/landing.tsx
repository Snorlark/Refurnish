      ...
      <div className="relative  h-screen bg-cover bg-center" style={{backgroundImage: 'url(/bg-heropage.png)'}}>
        ...
        <div className="relative z-10 h-full flex items-center justify-end pl-7 pr-8 md:pr-20 lg:pr-32">
          <div className="bg-(--color-white) backdrop-blur-sm p-10 radius-20 shadow-modern max-w-lg">
            ...
            <h1 className="text-[35px] md:text-[42px] font-bold text-(--color-olive) mb-3 leading-tight tracking-tight">
              Save $10 on your first order!
            </h1>
            <p className="text-(--color-black) mb-8 font-light leading-relaxed text-[15px] md:text-[16px]">
              Enjoy a 10% discount on your first two furniture purchases when you sign up today.
            </p>
            <button className="bg-(--color-olive) tracking-[0.1em] text-white px-10 py-4 rounded-full font-normal hover:bg-green-800 transition-modern text-[12px] md:text-[16px]">
              BUY NOW
            </button>
          </div>
        </div>
      ...
      <div className="py-20 px-6 lg:px-16 bg-gray-50/50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1  md:mx-20 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-16">
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map((item, index) => (
              <div key={index} className="bg-white radius-20 shadow-modern hover:shadow-modern-hover transition-modern overflow-hidden group">
                ...
                <div className="p-5">
                  <h3 className="font-bold text-(--color-olive) mb-2 text-[22px]">
                  ...
                  <p className="text-(--color-primary) font-medium text-[20px]">₱ 12,000.00</p>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center text-(--color-primary) font-light text-[16px] ">
          ...
          <div className="text-center">
            <button className=" shadow-sm box-sha tracking-[0.1em] text-(--color-primary) border-2 border-(--color-primary) px-10 py-4 rounded-full font-medium transition-modern text-lg">
              EXPLORE MORE
            </button>
          </div>
        </div>
