...
export const featuredProducts: Product[] = [
  ...
  { id: 9, name: 'Nightstand Pair', price: '₱ 9,800.00', priceNum: 9800, location: 'Amanpulo', image: '/bedroom.png', category: 'bedroom', dateAdded: '2024-01-14' },
  { id: 10, name: 'Floor Mirror', price: '₱ 7,500.00', priceNum: 7500, location: 'Amanpulo', image: '/living.png', category: 'mirror', dateAdded: '2024-01-16' },
  { id: 11, name: 'Vintage Armchair', price: '₱ 12,500.00', priceNum: 12500, location: 'Amanpulo', image: '/dining.png', category: 'chairs', dateAdded: '2024-01-28' },
  { id: 12, name: 'Modern Side Table', price: '₱ 5,800.00', priceNum: 5800, location: 'Amanpulo', image: '/bedroom.png', category: 'tables', dateAdded: '2024-01-30' },
];
...
export const forSwapProducts: Product[] = [
  { id: 29, name: 'Classic Cabinet', price: '', priceNum: 0, condition: 'Bookshelf', location: 'Basadang', image: '/bedroom.png', category: 'decor', dateAdded: '2024-02-02' },
  { id: 30, name: 'Wooden Chair', price: '', priceNum: 0, condition: 'Coffee Table', location: 'Bond Street', image: '/living.png', category: 'chairs', dateAdded: '2024-02-03' },
  { id: 31, name: 'Modern Sofa', price: '', priceNum: 0, condition: 'Rug', location: 'Bond Street', image: '/dining.png', category: 'tables', dateAdded: '2024-02-04' }
];