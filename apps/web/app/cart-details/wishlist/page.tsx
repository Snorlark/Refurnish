  ...
  return (
    <div className="min-h-screen flex flex-col font-['Futura']" >
      ...
      <main className="mx-auto w-full max-w-6xl px-4 sm:px-6 md:px-8 flex-1">
        ...
        <div className="mt-6 rounded-2xl bg-white shadow-sm ring-1 font-['Futura']  ring-black/[0.06]">
          <div className="grid grid-cols-[auto_1fr_auto_auto_auto] items-center gap-4 px-4 sm:px-6 py-3 text-sm font-semibold text-[#273815] font-['Futura']">
        ...
        <ul className="space-y-4 mt-4">
          {cartItems.map((item) => (
            ...
            >
              <div className="grid font-['Futura'] grid-cols-[auto_1fr_auto_auto_auto] items-center gap-4">
                <input
                  aria-label="Select item"
                  type="checkbox"
                  checked={item.selected}
                  onChange={() => toggleItemSelection(item.id)}
                  className="size-4 font-['Futura'] accent-green-800"
                />

                <div className="flex items-center gap-4 min-w-0">
                  <div className="size-14 font-['Futura']  rounded-lg bg-neutral-100 ring-1 ring-black/[0.06] overflow-hidden flex items-center justify-center text-xs text-neutral-500 shrink-0" style={{ fontFamily: 'Fustat, Arial, Helvetica, sans-serif' }}>
                    {item.thumbnailSrc ? (
                      <Image
                  ...
                  <div className="truncate">
                    <p className="truncate text-neutral-800  font-['Futura'] " >
                      {item.name}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="w-6 text-center select-none font-['Futura']  font-medium">{item.quantity}</span>
                  <IconButton
        ...
        <div className="mt-10 flex flex-col-reverse font-['Futura'] gap-4 sm:flex-row sm:items-center">
          <div className="flex-1">
            <div className="rounded-2xl font-['Futura'] bg-white shadow-sm ring-1 ring-black/[0.06] p-5" >
              <div className="flex items-center justify-between">
                <p className="text-xl font-semibold font-['Futura']  text-neutral-800">Total :</p>
                <p className="text-xl font-semibold font-['Futura']  text-[#636B2F] tabular-nums" >
        ...
        {!someSelected && (
          <p className="mt-2 font-['Futura'] text-sm text-neutral-500">Select at least one product to proceed to checkout.</p>
        )}
...
function SiteHeader() {
  return (
    <header className="w-full font-['Futura'] " >
      <div className="mx-auto font-['Futura'] w-full max-w-6xl px-4 sm:px-6 md:px-8 h-16 flex items-center gap-4">
        ...
        <div className="ml-2 hidden sm:flex items-center flex-1">
          <div className="w-full max-w-md relative">
            ...
            <input
              type="text"
              className="w-full font-['Futura']  h-9 rounded-full bg-neutral-100 ring-1 ring-black/[0.06] pl-10 pr-4 text-sm focus:outline-none focus:ring-green-800/40"
